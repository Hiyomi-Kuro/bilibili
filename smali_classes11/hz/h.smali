...
.method public a(Lgz/b;)V
    ...
    :cond_0
    :try_start_0
    const-string v0, "TargetFinishState end double Data"
    :try_end_0
...
.method public b(Lcom/bilibili/bililive/biz/view/dialog/PkScoreMultipleAwardResultData;)V
    ...
    :cond_0
    :try_start_0
    const-string v1, "TargetFinishState finish draw"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 56
    .line 57
    const-string v1, "finish_draw_state"
    ...
    .line 73
    .line 74
    invoke-virtual {v0, p1}, Lhz/f;->b(Lcom/bilibili/bililive/biz/view/dialog/PkScoreMultipleAwardResultData;)V
...
.method public d(Lgz/b;)V
    ...
    :cond_0
    :try_start_0
    const-string v1, "TargetFinishState interrupt end Data"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public e()V
    ...
    :cond_0
    :try_start_0
    const-string v1, "TargetFinishState no target finish"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public g(Lcom/bilibili/bililive/biz/uicommon/pk/LivePkScoreMultiple;)V
    ...
    :cond_0
    :try_start_0
    const-string v1, "TargetFinishState set score multiple info"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 85
    invoke-virtual {p1}, Lcom/bilibili/bililive/biz/uicommon/pk/LivePkScoreMultiple;->getDrawCardSurplusTime()J
    ...
    .line 89
    invoke-direct {v1, v0, v2, v3, v4}, Lgz/c;-><init>(ILjava/lang/String;J)V

    .line 90
    .line 91
    .line 92
    invoke-virtual {p0, v1}, Lhz/h;->i(Lgz/c;)V
...
.method public h(Lgz/b;)V
    ...
    :cond_0
    :try_start_0
    const-string v0, "TargetFinishState start double Data"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public i(Lgz/c;)V
    ...
    :cond_0
    :try_start_0
    const-string v1, "TargetFinishState target finish"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 62
    .line 63
    invoke-interface {v0, p1}, Lcom/bilibili/bililive/biz/scoremutiple/c;->a(Lgz/c;)V
...
.method public j(Lgz/a;)V
    ...
    .line 16
    :try_start_0
    const-string v3, "TargetFinishState; current status no start task"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
