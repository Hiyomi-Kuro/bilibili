...
.method public a(Lgz/b;)V
    ...
    :cond_0
    :try_start_0
    const-string v0, "FinishDrawState end double"
    :try_end_0
...
.method public b(Lcom/bilibili/bililive/biz/view/dialog/PkScoreMultipleAwardResultData;)V
    ...
    :cond_0
    :try_start_0
    const-string v1, "FinishDrawState finish draw"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 62
    .line 63
    invoke-interface {v0, p1}, Lcom/bilibili/bililive/biz/scoremutiple/c;->b(Lcom/bilibili/bililive/biz/view/dialog/PkScoreMultipleAwardResultData;)V
...
.method public d(Lgz/b;)V
    ...
    :cond_0
    :try_start_0
    const-string v1, "FinishDrawState interrupt end"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public e()V
    ...
    .line 16
    :try_start_0
    const-string v4, "FinishDrawState current status no target finish"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public g(Lcom/bilibili/bililive/biz/uicommon/pk/LivePkScoreMultiple;)V
    ...
    .line 28
    .line 29
    iget v1, p1, Lcom/bilibili/bililive/biz/uicommon/pk/LivePkScoreMultiple;->awardNum:I
    ...
    .line 36
    .line 37
    iget-wide v3, p1, Lcom/bilibili/bililive/biz/uicommon/pk/LivePkScoreMultiple;->awardContinueTime:J
    ...
    .line 53
    .line 54
    invoke-interface {p1, v0}, Lcom/bilibili/bililive/biz/scoremutiple/c;->b(Lcom/bilibili/bililive/biz/view/dialog/PkScoreMultipleAwardResultData;)V
...
.method public h(Lgz/b;)V
    ...
    :cond_0
    :try_start_0
    const-string v1, "FinishDrawState start double"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 56
    .line 57
    const-string v1, "being_double_state"
    ...
    .line 73
    .line 74
    invoke-virtual {v0, p1}, Lhz/f;->h(Lgz/b;)V
...
.method public i(Lgz/c;)V
    ...
    .line 16
    :try_start_0
    const-string v3, "FinishDrawState current status no target finish"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public j(Lgz/a;)V
    ...
    .line 16
    :try_start_0
    const-string v3, "FinishDrawState current status no start task"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
