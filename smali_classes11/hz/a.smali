...
.method public a(Lgz/b;)V
    ...
    :cond_0
    :try_start_0
    const-string v1, "EndDoubleState; end double"
    :try_end_0
    ...
    .line 62
    .line 63
    invoke-interface {v0, p1}, Lcom/bilibili/bililive/biz/scoremutiple/c;->c(Lgz/b;)V
...
.method public b(Lcom/bilibili/bililive/biz/view/dialog/PkScoreMultipleAwardResultData;)V
    ...
    .line 16
    :try_start_0
    const-string v3, "EndDoubleState; current status no finish Draw"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public d(Lgz/b;)V
    ...
    .line 16
    :try_start_0
    const-string v4, "EndDoubleState; current status no interrupt end"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public e()V
    ...
    .line 16
    :try_start_0
    const-string v4, "EndDoubleState; current status no no target finish"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public g(Lcom/bilibili/bililive/biz/uicommon/pk/LivePkScoreMultiple;)V
    ...
    .line 37
    .line 38
    invoke-virtual {p0, v1}, Lhz/a;->a(Lgz/b;)V
...
.method public h(Lgz/b;)V
    ...
    .line 16
    :try_start_0
    const-string v3, "EndDoubleState; current status no start double"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public i(Lgz/c;)V
    ...
    .line 16
    :try_start_0
    const-string v3, "EndDoubleState; current status no target finish"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public j(Lgz/a;)V
    ...
    .line 16
    :try_start_0
    const-string v3, "EndDoubleState; current status no start task"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
