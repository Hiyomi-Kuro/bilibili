.class final Lcom/bilibili/lib/fasthybrid/biz/debug/SmallAppDebugActivity$config$items$9;
...
# direct methods
.method constructor <init>(Landroid/content/SharedPreferences;Landroidx/recyclerview/widget/RecyclerView;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lcom/bilibili/lib/fasthybrid/biz/debug/SmallAppDebugActivity$config$items$9;->$sp:Landroid/content/SharedPreferences;

    .line 2
    .line 3
    iput-object p2, p0, Lcom/bilibili/lib/fasthybrid/biz/debug/SmallAppDebugActivity$config$items$9;->$rv:Landroidx/recyclerview/widget/RecyclerView;
...
.method public static synthetic a(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    .line 1
    invoke-static {p0}, Lcom/bilibili/lib/fasthybrid/biz/debug/SmallAppDebugActivity$config$items$9;->invoke$lambda$2(Landroidx/recyclerview/widget/RecyclerView;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/bilibili/lib/fasthybrid/biz/debug/SmallAppDebugActivity$config$items$9;->invoke(Landroid/view/View;Lcom/bilibili/lib/fasthybrid/biz/debug/SmallAppDebugActivity$f;Z)V
...
.method public final invoke(Landroid/view/View;Lcom/bilibili/lib/fasthybrid/biz/debug/SmallAppDebugActivity$f;Z)V
    ...
    iget-object v0, p0, Lcom/bilibili/lib/fasthybrid/biz/debug/SmallAppDebugActivity$config$items$9;->$sp:Landroid/content/SharedPreferences;
    ...
    iget-object p2, p0, Lcom/bilibili/lib/fasthybrid/biz/debug/SmallAppDebugActivity$config$items$9;->$rv:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-virtual {v0, p2}, Lcom/bilibili/lib/fasthybrid/biz/debug/SmallAppDebugActivity$f;->f(Z)V
    ...
    const-string v3, "force_game_webview"
    ...
    invoke-virtual {v2, p2}, Lcom/bilibili/lib/fasthybrid/biz/debug/SmallAppDebugActivity$f;->f(Z)V

    :goto_8
    iget-object p2, p0, Lcom/bilibili/lib/fasthybrid/biz/debug/SmallAppDebugActivity$config$items$9;->$sp:Landroid/content/SharedPreferences;
    ...
    invoke-virtual {p2}, Lcom/bilibili/lib/fasthybrid/SmallAppManager;->o()V

    iget-object p2, p0, Lcom/bilibili/lib/fasthybrid/biz/debug/SmallAppDebugActivity$config$items$9;->$rv:Landroidx/recyclerview/widget/RecyclerView;

    .line 9
    new-instance p3, Lcom/bilibili/lib/fasthybrid/biz/debug/w;

    invoke-direct {p3, p2}, Lcom/bilibili/lib/fasthybrid/biz/debug/w;-><init>(Landroidx/recyclerview/widget/RecyclerView;)V
