...
.field private static final FRAGMENT_SHADER_VER3:Ljava/lang/String; = "uniform vec2 xUnit;\nuniform vec4 coeffs;\nvoid main() {\n  vec3 sample1 = texture(tex, tc - 1.5 * xUnit).rgb;\n  vec3 sample2 = texture(tex, tc - 0.5 * xUnit).rgb;\n  vec3 sample3 = texture(tex, tc + 0.5 * xUnit).rgb;\n  vec3 sample4 = texture(tex, tc + 1.5 * xUnit).rgb;\n\n  fragColor.r = coeffs.a + dot(coeffs.rgb, sample1);\n  fragColor.g = coeffs.a + dot(coeffs.rgb, sample2);\n  fragColor.b = coeffs.a + dot(coeffs.rgb, sample3);\n  fragColor.a = coeffs.a + dot(coeffs.rgb, sample4);\n}"
