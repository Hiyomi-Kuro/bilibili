.class public final Lcom/bapis/bilibili/app/dynamic/v2/qq$f;
...
.method synthetic constructor <init>(Lio/grpc/d;Lio/grpc/c;Lcom/bapis/bilibili/app/dynamic/v2/qq$a;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Lcom/bapis/bilibili/app/dynamic/v2/qq$f;-><init>(Lio/grpc/d;Lio/grpc/c;)V
...
# virtual methods
.method protected build(Lio/grpc/d;Lio/grpc/c;)Lcom/bapis/bilibili/app/dynamic/v2/qq$f;
    .locals 1

    .line 2
    new-instance v0, Lcom/bapis/bilibili/app/dynamic/v2/qq$f;

    invoke-direct {v0, p1, p2}, Lcom/bapis/bilibili/app/dynamic/v2/qq$f;-><init>(Lio/grpc/d;Lio/grpc/c;)V
...
.method protected bridge synthetic build(Lio/grpc/d;Lio/grpc/c;)Lio/grpc/stub/d;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lcom/bapis/bilibili/app/dynamic/v2/qq$f;->build(Lio/grpc/d;Lio/grpc/c;)Lcom/bapis/bilibili/app/dynamic/v2/qq$f;
...
.method public listCreation(Lcom/bapis/bilibili/app/dynamic/v2/ListCreationReq;Lio/grpc/stub/i;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public listFav(Lcom/bapis/bilibili/app/dynamic/v2/ListFavReq;Lio/grpc/stub/i;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public opusCollectionDetail(Lcom/bapis/bilibili/app/dynamic/v2/OpusCollectionDetailReq;Lio/grpc/stub/i;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public opusDetail(Lcom/bapis/bilibili/app/dynamic/v2/OpusDetailReq;Lio/grpc/stub/i;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public opusSpaceFlow(Lcom/bapis/bilibili/app/dynamic/v2/OpusSpaceFlowReq;Lio/grpc/stub/i;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public signResources(Lcom/bapis/bilibili/app/dynamic/v2/SignResourcesReq;Lio/grpc/stub/i;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
