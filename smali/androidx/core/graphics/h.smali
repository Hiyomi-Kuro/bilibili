...
.method static constructor <clinit>()V
    ...
    .line 70
    .line 71
    sput-object v0, Landroidx/core/graphics/h;->b:Landroidx/collection/x;
...
.method public static b(Landroid/content/Context;Landroid/os/CancellationSignal;[Le2/h$b;I)Landroid/graphics/Typeface;
    .locals 1
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 2
    .line 3
    invoke-virtual {v0, p0, p1, p2, p3}, Landroidx/core/graphics/n;->b(Landroid/content/Context;Landroid/os/CancellationSignal;[Le2/h$b;I)Landroid/graphics/Typeface;
...
.method public static c(Landroid/content/Context;Landroidx/core/content/res/e$b;Landroid/content/res/Resources;ILjava/lang/String;IILandroidx/core/content/res/h$f;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    .param p0    # Landroid/content/Context;
        ...
        .end annotation
    .end param
    .param p1    # Landroidx/core/content/res/e$b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    .param p4    # Ljava/lang/String;
        ...
        .end annotation
    .end param
    .param p7    # Landroidx/core/content/res/h$f;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    ...
    .line 23
    .line 24
    invoke-virtual {v1, v3, v2}, Landroidx/core/content/res/h$f;->callbackSuccessAsync(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    .line 55
    :goto_2
    invoke-static/range {p8 .. p8}, Landroidx/core/content/res/h$f;->getHandler(Landroid/os/Handler;)Landroid/os/Handler;
    ...
    .line 60
    .line 61
    invoke-direct {v12, v1}, Landroidx/core/graphics/h$a;-><init>(Landroidx/core/content/res/h$f;)V

    .line 62
    .line 63
    .line 64
    invoke-virtual {v0}, Landroidx/core/content/res/e$e;->b()Le2/f;
    ...
    .line 70
    .line 71
    invoke-static/range {v6 .. v12}, Le2/h;->c(Landroid/content/Context;Le2/f;IZILandroid/os/Handler;Le2/h$c;)Landroid/graphics/Typeface;
    ...
    .line 86
    .line 87
    invoke-virtual {v3, p0, v0, p2, v6}, Landroidx/core/graphics/n;->a(Landroid/content/Context;Landroidx/core/content/res/e$c;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    .line 94
    .line 95
    invoke-virtual {v1, v0, v2}, Landroidx/core/content/res/h$f;->callbackSuccessAsync(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    .line 100
    invoke-virtual {v1, v3, v2}, Landroidx/core/content/res/h$f;->callbackFailAsync(ILandroid/os/Handler;)V
    ...
    .line 104
    .line 105
    sget-object v1, Landroidx/core/graphics/h;->b:Landroidx/collection/x;
...
.method public static d(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;II)Landroid/graphics/Typeface;
    ...
    .line 18
    sget-object p2, Landroidx/core/graphics/h;->b:Landroidx/collection/x;
...
.method public static f(Landroid/content/res/Resources;ILjava/lang/String;II)Landroid/graphics/Typeface;
    ...
    .line 1
    sget-object v0, Landroidx/core/graphics/h;->b:Landroidx/collection/x;
