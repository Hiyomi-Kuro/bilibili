...
.method public final invoke(Landroidx/compose/foundation/text/selection/x;)V
    ...
    .line 3
    :pswitch_0
    invoke-static {}, Landroidx/compose/foundation/text/d;->b()V
    ...
    .line 4
    invoke-virtual {p1}, Landroidx/compose/foundation/text/TextFieldKeyInput;->k()Landroidx/compose/foundation/text/h0;

    move-result-object p1

    if-eqz p1, :cond_3

    invoke-virtual {p1}, Landroidx/compose/foundation/text/h0;->c()Landroidx/compose/ui/text/input/TextFieldValue;
    ...
    invoke-static {v0}, Landroidx/compose/foundation/text/TextFieldKeyInput;->d(Landroidx/compose/foundation/text/TextFieldKeyInput;)Lsf3/l;
    ...
    .line 5
    invoke-virtual {v0}, Landroidx/compose/foundation/text/TextFieldKeyInput;->k()Landroidx/compose/foundation/text/h0;
    ...
    invoke-virtual {v0, p1}, Landroidx/compose/foundation/text/h0;->b(Landroidx/compose/ui/text/input/TextFieldValue;)V
    ...
    invoke-virtual {p1}, Landroidx/compose/foundation/text/h0;->g()Landroidx/compose/ui/text/input/TextFieldValue;
    ...
    invoke-static {p1, v0}, Landroidx/compose/foundation/text/TextFieldKeyInput;->a(Landroidx/compose/foundation/text/TextFieldKeyInput;Landroidx/compose/ui/text/input/h;)V
    ...
    invoke-static {v0}, Landroidx/compose/ui/text/input/p;->j(I)Landroidx/compose/ui/text/input/p;
    ...
    invoke-virtual {p1, v0}, Landroidx/compose/foundation/text/selection/x;->Y(Lsf3/l;)Ljava/util/List;
    ...
    invoke-virtual {p1, v0}, Landroidx/compose/foundation/text/selection/a;->c(Lsf3/l;)Landroidx/compose/foundation/text/selection/a;
    ...
    invoke-virtual {p1, v0}, Landroidx/compose/foundation/text/selection/a;->b(Lsf3/l;)Landroidx/compose/foundation/text/selection/a;
