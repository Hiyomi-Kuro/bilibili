...
.method public mayLaunchUrl(Landroid/support/customtabs/ICustomTabsCallback;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    ...
    .line 4
    .line 5
    invoke-direct {v1, p1}, Landroidx/browser/customtabs/a;-><init>(Landroid/support/customtabs/ICustomTabsCallback;)V

    .line 6
    .line 7
    .line 8
    invoke-virtual {v0, v1, p2, p3, p4}, Landroidx/browser/customtabs/CustomTabsService;->c(Landroidx/browser/customtabs/a;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
...
.method public newSession(Landroid/support/customtabs/ICustomTabsCallback;)Z
    ...
    .line 2
    .line 3
    invoke-direct {v0, p1}, Landroidx/browser/customtabs/a;-><init>(Landroid/support/customtabs/ICustomTabsCallback;)V
    ...
    .line 8
    .line 9
    invoke-direct {v2, p0, v0}, Landroidx/browser/customtabs/CustomTabsService$a$a;-><init>(Landroidx/browser/customtabs/CustomTabsService$a;Landroidx/browser/customtabs/a;)V
    ...
    .line 37
    .line 38
    invoke-virtual {p1, v0}, Landroidx/browser/customtabs/CustomTabsService;->d(Landroidx/browser/customtabs/a;)Z
...
.method public postMessage(Landroid/support/customtabs/ICustomTabsCallback;Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    .line 7
    .line 8
    invoke-virtual {v0, v1, p2, p3}, Landroidx/browser/customtabs/CustomTabsService;->e(Landroidx/browser/customtabs/a;Ljava/lang/String;Landroid/os/Bundle;)I
...
.method public requestPostMessageChannel(Landroid/support/customtabs/ICustomTabsCallback;Landroid/net/Uri;)Z
    ...
    .line 7
    .line 8
    invoke-virtual {v0, v1, p2}, Landroidx/browser/customtabs/CustomTabsService;->f(Landroidx/browser/customtabs/a;Landroid/net/Uri;)Z
...
.method public updateVisuals(Landroid/support/customtabs/ICustomTabsCallback;Landroid/os/Bundle;)Z
    ...
    .line 7
    .line 8
    invoke-virtual {v0, v1, p2}, Landroidx/browser/customtabs/CustomTabsService;->g(Landroidx/browser/customtabs/a;Landroid/os/Bundle;)Z
...
.method public validateRelationship(Landroid/support/customtabs/ICustomTabsCallback;ILandroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    .line 7
    .line 8
    invoke-virtual {v0, v1, p2, p3, p4}, Landroidx/browser/customtabs/CustomTabsService;->h(Landroidx/browser/customtabs/a;ILandroid/net/Uri;Landroid/os/Bundle;)Z
