...
.method constructor <init>(Landroidx/appcompat/app/AppCompatDelegateImpl;Landroid/view/Window$Callback;)V
    ...
    .line 2
    .line 3
    invoke-direct {p0, p2}, Ly/m;-><init>(Landroid/view/Window$Callback;)V
...
# virtual methods
.method b(Landroidx/appcompat/app/AppCompatDelegateImpl$g;)V
    .locals 0
    .param p1    # Landroidx/appcompat/app/AppCompatDelegateImpl$g;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param

    .line 1
    iput-object p1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$n;->b:Landroidx/appcompat/app/AppCompatDelegateImpl$g;
...
.method final c(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    .line 6
    .line 7
    invoke-direct {v0, v1, p1}, Ly/f$a;-><init>(Landroid/content/Context;Landroid/view/ActionMode$Callback;)V
    ...
    .line 11
    .line 12
    invoke-virtual {p1, v0}, Landroidx/appcompat/app/AppCompatDelegateImpl;->H(Ly/b$a;)Ly/b;
    ...
    .line 17
    .line 18
    invoke-virtual {v0, p1}, Ly/f$a;->e(Ly/b;)Landroid/view/ActionMode;
...
.method public dispatchKeyShortcutEvent(Landroid/view/KeyEvent;)Z
    ...
    .line 1
    invoke-super {p0, p1}, Ly/m;->dispatchKeyShortcutEvent(Landroid/view/KeyEvent;)Z
...
.method public onCreatePanelMenu(ILandroid/view/Menu;)Z
    ...
    .line 9
    :cond_0
    invoke-super {p0, p1, p2}, Ly/m;->onCreatePanelMenu(ILandroid/view/Menu;)Z
...
.method public onCreatePanelView(I)Landroid/view/View;
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$n;->b:Landroidx/appcompat/app/AppCompatDelegateImpl$g;
    ...
    .line 12
    :cond_0
    invoke-super {p0, p1}, Ly/m;->onCreatePanelView(I)Landroid/view/View;
...
.method public onMenuOpened(ILandroid/view/Menu;)Z
    ...
    .line 1
    invoke-super {p0, p1, p2}, Ly/m;->onMenuOpened(ILandroid/view/Menu;)Z
...
.method public onPanelClosed(ILandroid/view/Menu;)V
    ...
    .line 1
    invoke-super {p0, p1, p2}, Ly/m;->onPanelClosed(ILandroid/view/Menu;)V
...
.method public onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
    ...
    .line 22
    :cond_2
    iget-object v3, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$n;->b:Landroidx/appcompat/app/AppCompatDelegateImpl$g;
    ...
    .line 35
    .line 36
    invoke-super {p0, p1, p2, p3}, Ly/m;->onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
...
.method public onProvideKeyboardShortcuts(Ljava/util/List;Landroid/view/Menu;I)V
    ...
    .line 14
    .line 15
    invoke-super {p0, p1, v0, p3}, Ly/m;->onProvideKeyboardShortcuts(Ljava/util/List;Landroid/view/Menu;I)V
    ...
    .line 19
    :cond_0
    invoke-super {p0, p1, p2, p3}, Ly/m;->onProvideKeyboardShortcuts(Ljava/util/List;Landroid/view/Menu;I)V
...
.method public onWindowStartingActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    .line 2
    invoke-virtual {p0, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl$n;->c(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    .line 3
    :cond_1
    invoke-super {p0, p1}, Ly/m;->onWindowStartingActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
...
.method public onWindowStartingActionMode(Landroid/view/ActionMode$Callback;I)Landroid/view/ActionMode;
    ...
    :cond_1
    :goto_0
    invoke-super {p0, p1, p2}, Ly/m;->onWindowStartingActionMode(Landroid/view/ActionMode$Callback;I)Landroid/view/ActionMode;
