...
.method private a(Landroid/content/Context;Le2/f;)Landroidx/emoji2/text/f$c;
    .locals 1
    ...
    .line 6
    .line 7
    invoke-direct {v0, p1, p2}, Landroidx/emoji2/text/k;-><init>(Landroid/content/Context;Le2/f;)V
...
.method private d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Le2/f;
    .locals 3
    ...
    .line 6
    .line 7
    invoke-virtual {v1, p2, p1}, Landroidx/emoji2/text/d$b;->c(Landroid/content/pm/PackageManager;Ljava/lang/String;)[Landroid/content/pm/Signature;
    ...
    .line 18
    .line 19
    invoke-direct {v1, v0, p1, v2, p2}, Le2/f;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
...
.method private g(Landroid/content/pm/PackageManager;)Landroid/content/pm/ProviderInfo;
    ...
    .line 11
    invoke-virtual {v0, p1, v1, v2}, Landroidx/emoji2/text/d$b;->d(Landroid/content/pm/PackageManager;Landroid/content/Intent;I)Ljava/util/List;
    ...
    .line 32
    .line 33
    invoke-virtual {v1, v0}, Landroidx/emoji2/text/d$b;->b(Landroid/content/pm/ResolveInfo;)Landroid/content/pm/ProviderInfo;
...
.method public c(Landroid/content/Context;)Landroidx/emoji2/text/f$c;
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/emoji2/text/d$a;->h(Landroid/content/Context;)Le2/f;
    ...
    .line 5
    invoke-direct {p0, p1, v0}, Landroidx/emoji2/text/d$a;->a(Landroid/content/Context;Le2/f;)Landroidx/emoji2/text/f$c;
...
.method h(Landroid/content/Context;)Le2/f;
    .locals 2
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 6
    .line 7
    invoke-static {p1, v0}, Lf2/j;->h(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, v0, p1}, Landroidx/emoji2/text/d$a;->d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Le2/f;
