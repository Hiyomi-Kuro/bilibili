...
.method private static adapt(Lj$/util/stream/Sink;)Ljava/util/function/IntConsumer;
    ...
    invoke-direct {v0, p0}, Lj$/util/stream/IntPipeline$$ExternalSyntheticLambda1;-><init>(Lj$/util/stream/Sink;)V
...
.method public final average()Lj$/util/OptionalDouble;
    ...
    invoke-direct {v0}, Lj$/util/stream/IntPipeline$$ExternalSyntheticLambda4;-><init>()V

    new-instance v1, Lj$/util/stream/IntPipeline$$ExternalSyntheticLambda5;

    invoke-direct {v1}, Lj$/util/stream/IntPipeline$$ExternalSyntheticLambda5;-><init>()V

    new-instance v2, Lj$/util/stream/IntPipeline$$ExternalSyntheticLambda6;

    invoke-direct {v2}, Lj$/util/stream/IntPipeline$$ExternalSyntheticLambda6;-><init>()V
...
.method public final collect(Ljava/util/function/Supplier;Ljava/util/function/ObjIntConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p3}, Lj$/util/stream/IntPipeline$$ExternalSyntheticLambda10;-><init>(Ljava/util/function/BiConsumer;)V
...
.method public final distinct()Lj$/util/stream/IntStream;
    ...
    new-instance v1, Lj$/util/stream/IntPipeline$$ExternalSyntheticLambda0;

    invoke-direct {v1}, Lj$/util/stream/IntPipeline$$ExternalSyntheticLambda0;-><init>()V
...
.method public final max()Lj$/util/OptionalInt;
    ...
    new-instance v0, Lj$/util/stream/IntPipeline$$ExternalSyntheticLambda9;

    invoke-direct {v0}, Lj$/util/stream/IntPipeline$$ExternalSyntheticLambda9;-><init>()V
...
.method public final min()Lj$/util/OptionalInt;
    ...
    new-instance v0, Lj$/util/stream/IntPipeline$$ExternalSyntheticLambda11;

    invoke-direct {v0}, Lj$/util/stream/IntPipeline$$ExternalSyntheticLambda11;-><init>()V
