...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lj$/util/stream/ReduceOps;->makeIntCounting()Lj$/util/stream/TerminalOp;
.end annotation
...
.method public bridge synthetic evaluateParallel(Lj$/util/stream/PipelineHelper;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/ReduceOps$9;->evaluateParallel(Lj$/util/stream/PipelineHelper;Lj$/util/Spliterator;)Ljava/lang/Long;
...
.method public bridge synthetic evaluateSequential(Lj$/util/stream/PipelineHelper;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/ReduceOps$9;->evaluateSequential(Lj$/util/stream/PipelineHelper;Lj$/util/Spliterator;)Ljava/lang/Long;
...
.method public bridge synthetic makeSink()Lj$/util/stream/ReduceOps$AccumulatingSink;
    ...
    invoke-virtual {p0}, Lj$/util/stream/ReduceOps$9;->makeSink()Lj$/util/stream/ReduceOps$CountingSink;
...
.method public makeSink()Lj$/util/stream/ReduceOps$CountingSink;
    ...
    new-instance v0, Lj$/util/stream/ReduceOps$CountingSink$OfInt;

    invoke-direct {v0}, Lj$/util/stream/ReduceOps$CountingSink$OfInt;-><init>()V
