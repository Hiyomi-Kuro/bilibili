.class public final Lcom/bapis/bilibili/api/probe/v1/h$f;
...
.method synthetic constructor <init>(Lio/grpc/d;Lio/grpc/c;Lcom/bapis/bilibili/api/probe/v1/h$a;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Lcom/bapis/bilibili/api/probe/v1/h$f;-><init>(Lio/grpc/d;Lio/grpc/c;)V
...
# virtual methods
.method protected build(Lio/grpc/d;Lio/grpc/c;)Lcom/bapis/bilibili/api/probe/v1/h$f;
    .locals 1

    .line 2
    new-instance v0, Lcom/bapis/bilibili/api/probe/v1/h$f;

    invoke-direct {v0, p1, p2}, Lcom/bapis/bilibili/api/probe/v1/h$f;-><init>(Lio/grpc/d;Lio/grpc/c;)V
...
.method protected bridge synthetic build(Lio/grpc/d;Lio/grpc/c;)Lio/grpc/stub/d;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lcom/bapis/bilibili/api/probe/v1/h$f;->build(Lio/grpc/d;Lio/grpc/c;)Lcom/bapis/bilibili/api/probe/v1/h$f;
...
.method public testCode(Lcom/bapis/bilibili/api/probe/v1/CodeReq;Lio/grpc/stub/i;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public testReq(Lcom/bapis/bilibili/api/probe/v1/ProbeReq;Lio/grpc/stub/i;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public testStream(Lio/grpc/stub/i;)Lio/grpc/stub/i;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public testSub(Lcom/bapis/bilibili/api/probe/v1/ProbeSubReq;Lio/grpc/stub/i;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
